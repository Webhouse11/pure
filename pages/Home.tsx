...
const Home: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => setShowInterstitial(true), 3000);
    return () => clearTimeout(timer);
  }, []);

  const featured = posts[0] || INITIAL_POSTS[0];
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-28 space-y-12">
            ...
            <div className="bg-black text-white p-10 shadow-2xl relative overflow-hidden">
              ...
              <button className="w-full bg-red-600 text-white py-5 text-[10px] font-black uppercase hover:bg-white hover:text-black transition tracking-[0.3em] relative z-10">Get Access</button>
            </div>
